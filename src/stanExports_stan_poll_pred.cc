...
#include "stanExports_stan_poll_pred.h"

RCPP_MODULE(stan_fit4stan_poll_pred_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_stan_poll_pred")
